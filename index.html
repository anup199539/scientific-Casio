        ...
        <table class="center">
          ...
          <script>
              function display(digit){
                  var inputdigit=document.getElementById("input")
                  inputdigit.value+=digit
                  console.log(inputdigit.value)
              }
              function calculate(){
                  var string = document.getElementById("input").value;
                  var cal = eval(string);
                  document.getElementById("input").value=cal
              ...
              function sin(){
                var string = document.getElementById("input").value;
                var sinval=Math.sin(string);
                document.getElementById("input").value=sinval
            }
            function cos(){
                var string = document.getElementById("input").value;
                var cosval=Math.cos(string);
                document.getElementById("input").value=cosval
            }
            function tan(){
                var string = document.getElementById("input").value;
                var tanval=Math.cos(string);
                document.getElementById("input").value=tanval
            }
            function pi(){
                var string = document.getElementById("input").value;
                var pival=string*3.14159;
                document.getElementById("input").value=pival;
            }
            function log(){
                var string = document.getElementById("input").value;
                var logval= Math.log(string);
                document.getElementById("input").value=logval

            }
            function pow(){
                var string = document.getElementById("input").value;
                var powval= Math.pow(string);
                document.getElementById("input").value=powval

            }
            function percent(){
                var string = document.getElementById("input").value;
                var percentval= 
                document.getElementById("input").value=percentval

            }
            function squareroot(){
                var string = document.getElementById("input").value;
                var sqrtval= Math.sqrt(string)
                document.getElementById("input").value=sqrtval

            }
            function exponential(){
                var string = document.getElementById("input").value;
                var expval= Math.exp(string);
                document.getElementById("input").value=expval;
            }
            function allclear(){
                document.getElementById("input").value =  "";
            }
            function backspace(){
                var lastvalue = document.getElementById("input").value;
                document.getElementById("input").value = lastvalue.substr(0,  lastvalue.length - 1);
